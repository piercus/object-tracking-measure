...
* @param {Any} obj1
* @param {Any} obj2
* @param {Options} opts object containing {index}
* @returns {Number}
*/
/**
* @callback MapCb
...
/**
* List the indexes that are truthy for both
* @param {Array.<Array.<Any>>} groundTruths
* @param {Array.<Array.<Any>>} predictions
* @param {Number} threshold
* @param {DistCb} [distFn=1 - iou]
* @param {MapCb} [mapFn = (o => o)]
* @param {Object} logger console-like (or winston-like) interface for logging
...
module.exports = function (options) {
	...
	*/
	const detailedDistFn = function (gt, pred) {
		...
		const spatialMatches = inter.filter(index => distFn(mapFn(gt[index]), mapFn(pred[index]), {frameIndex: index}) < threshold);
